...
public class PeaTest {
    ...
    public void tearDown() throws Exception {
        testItem = null;
        gamePanel.getLanes().getLanePeas().get(0).remove(0);
        gamePanel = null;
    }
    ...
    public void testNormalPeaAdvance() {
        ...
        gamePanel.getLanes().getLanePeas().get(0).add(testItem);

        int xPositionOrigin = gamePanel.getLanes().getLanePeas().get(0).get(0).getXPosition();

        gamePanel.advance();

        int xPositionAfterAdvance = gamePanel.getLanes().getLanePeas().get(0).get(0).getXPosition();
    ...
    public void testFreezePeaAdvance() {
        ...
        System.out.println(gamePanel.getLanes().getLanePeas().get(0).get(0).getXPosition());
    ...
    public void testPeaAttackZombie299() {
        ...
        gamePanel.getLanes().getLaneZombies().get(0).add(zombie);

        for(int i = 0; i < 100; i++)
            gamePanel.advance();

        assertTrue(gamePanel.getLanes().getLaneZombies().get(0).isEmpty());
    }
    ...
    public void testPeaAttackZombie301() {
        ...
        assertFalse(gamePanel.getLanes().getLaneZombies().get(0).isEmpty());
    }
}
